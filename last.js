...
var getAllToggle = document.querySelector(
  ".cookie-detail-headline .cookie-toggle input"
);
var cookieCatagoryName = document.querySelector(
...
var preferenceConsentButton = document.getElementById(
...
preferenceConsentButton.onclick = () => {
  ...
  if (detailsSec.style.display == "none") {
    ...
    consentSection.style.display = "Block";
    document.getElementById("preferenceConsentButton").innerText =
      "PREFERENCES";
    document.getElementsByClassName(
      "consent-content-area"
    )[0].style.flexDirection = "row";
...
var matchedCookies = [
  {
    ...
    description:
      "Používáno Facebookem k doručování řady reklamních produktů, jako je real-time bidding od třetích stran",
  ...
  },
  {
    ...
    domain: "https://carplaydiy.com/",
    description:
      "Primární cookie používaná Google Analytics k rozlišení jednoho návštěvníka od druhého",
  ...
  },
  {
    ...
    domain: "https://carplaydiy.com/",
    description:
      "Pro zajištění ochrany proti hackerům uchovávejte údaje o účtu.",
  ...
  },
  {
    ...
    domain: "https://carplaydiy.com/",
    description:
      "Ukládat a kombinovat zobrazení stránek uživatelem do jednoho záznamu relace.",
    retention_period: "1 day",
    data_controller: "Microsoft Clarity",
    privary_rights_portals:
      "https://privacy.microsoft.com/en-us/privacystatement",
  ...
  },
  {
    ...
    domain: "https://carplaydiy.com/",
    description:
      "Používá se knihovnou Simple Behavioral JavaScript (SBJS) k ukládání dalších dat souvisejících s chováním nebo interakcemi aktuálního uživatele na webu.",
    retention_period: "6 month",
    data_controller: "Sourcebuster JS",
    privary_rights_portals: "#",
    wildcard_match: 0,
...
var getNecessarySection = document.querySelector(
  ".necessaryCookies .all-cookies"
);
var getPreferencesSection = document.querySelector(
  ".preferencesCookies .all-cookies"
);
var getAnalyticsSection = document.querySelector(
  ".analyticsCookies .all-cookies"
);
var getMarketingSection = document.querySelector(
  ".marketingCookies .all-cookies"
);
...
function generalCode() {
  ...
  var cookieProviderHeadlines = document.querySelectorAll(
  ...
  cookieProviderHeadlines.forEach(function (headline, index) {
    headline.onclick = function () {
      var actualCookieWrappers = this.closest(".cookies").querySelectorAll(
